...
theme.fg_focus                                  = "#7f008a"
--theme.fg_focus                                  = "#ff8c00"
theme.fg_minimize                               = "#ffffff"
theme.border_width                              = dpi(2)
theme.border_normal                             = "#1c2022"
--theme.border_focus                              = "#5e81ac"
theme.border_focus                              = "#7f008a"
...
local mytextclock = wibox.widget.textclock(markup("#7788af", "%A %d %B - ") .. markup("#7788af", "%H:%M "))
